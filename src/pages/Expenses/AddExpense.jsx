...
export function AddExpense() {
  ...
  const [entries, setEntries] = React.useState([
    { head: 'Electricity Bill - March', amount: '4,500.00' },
    { head: 'Office Stationery', amount: '1,200.00' },
    { head: '', amount: '' }
  ]);
  ...
  const [receiptNo, setReceiptNo] = React.useState('882');
  ...
  return (
    <div className="flex flex-col h-screen bg-[#f3f4f6]">
      <div className="bg-[#51A2FF] border-b border-gray-400 shadow-2xl font-sans text-black flex flex-col h-full w-full">
        ...
        <div className="p-3 border-b border-gray-400">
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-4">
              <div className="bg-[#e04040] text-white px-8 py-0.5 text-[14px] font-bold shadow-sm uppercase">Payment</div>
      ...
      <div className="max-w-6xl mx-auto w-full mt-4 flex justify-end gap-3 pb-4 px-4">
        ...
        <button className="bg-[#3e7e7b] text-white px-8 py-2 rounded font-bold text-sm hover:bg-[#2f5e5c] transition shadow-md flex items-center gap-2">
          <Icons.Check className="w-4 h-4" /> Save Payment Voucher
        </button>
      </div>
