...
export function IncomeHead() {
  const heads = [
    { name: 'Donations', description: 'Institutional donations' },
    { name: 'Grants', description: 'Government grants' },
    { name: 'Misc Income', description: 'Other miscellaneous income' },
  ];
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto pb-10">
      <div className="lg:w-1/3">
        <div className="bg-white border border-gray-200 rounded shadow-sm">
          <div className="px-4 py-3 border-b border-gray-100">
            <h3 className="text-gray-700 font-semibold text-lg">Add Income Head</h3>
          </div>
          <div className="p-4 flex flex-col gap-4">
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1">Income Head <span className="text-red-500">*</span></label>
      ...
      <div className="lg:w-2/3">
        <div className="bg-white border border-gray-200 rounded shadow-sm">
          <div className="px-4 py-3 border-b border-gray-100">
            <h3 className="text-gray-700 font-semibold text-lg">Income Head List</h3>
          </div>
          <div className="p-4">
