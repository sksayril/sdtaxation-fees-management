  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto pb-10">
      <div className="lg:w-1/3">
        <div className="bg-white border border-gray-200 rounded shadow-sm">
          <div className="px-4 py-3 border-b border-gray-100">
            <h3 className="text-gray-700 font-semibold text-lg">Add Income</h3>
          </div>
      ...
      <div className="lg:w-2/3">
        <div className="bg-white border border-gray-200 rounded shadow-sm">
          <div className="px-4 py-3 border-b border-gray-100">
            <h3 className="text-gray-700 font-semibold text-lg">Income List</h3>
          </div>
          <div className="p-4">
                ...
                <tbody>
                  {incomes.map((inc, i) => (
                    <tr key={i} className="border-b border-gray-100 hover:bg-gray-50">
                      <td className="px-4 py-3 text-blue-600 font-medium">{inc.name}</td>
                      <td className="px-4 py-3 text-gray-600">{inc.invoice}</td>
                      <td className="px-4 py-3 text-gray-600">{inc.incomeHead}</td>
                      <td className="px-4 py-3 text-gray-600">{inc.date}</td>
                      <td className="px-4 py-3 text-gray-800 font-bold text-right">{inc.amount}</td>
