...
export function StudentDetails() {
  ...
  const students = [
    { admNo: '1800011', name: 'Edward Thomas', rollNo: '001', class: 'Class 1(A)', father: 'Olivier Thomas', dob: '04/08/2020', gender: 'Male', category: 'OBC', mobile: '98262573272' },
    { admNo: '002', name: 'Sneha Patel', rollNo: '', class: 'Class 1(A)', father: 'Ramesh Patel', dob: '07/15/2016', gender: 'Female', category: '', mobile: '9876200001' },
    { admNo: '003', name: 'Hariom Yadav', rollNo: '', class: 'Class 1(A)', father: '', dob: '04/08/2020', gender: 'Male', category: 'OBC', mobile: '' },
    { admNo: 'A003', name: 'Hariom Yadav', rollNo: '', class: 'Class 1(A)', father: '', dob: '04/08/2020', gender: 'Male', category: 'OBC', mobile: '' },
    { admNo: 'A004', name: 'Nisha', rollNo: '', class: 'Class 1(A)', father: '', dob: '04/15/2026', gender: 'Female', category: 'General', mobile: '' },
    { admNo: 'A41003', name: 'niya', rollNo: '', class: 'Class 1(A)', father: '', dob: '04/22/2026', gender: 'Male', category: '', mobile: '' },
  ];
      ...
      <div className="bg-white border border-gray-200 rounded shadow-sm">
        ...
        <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
          ...
          <div className="flex gap-4 items-end">
            ...
            <button className="bg-[#3b5998] text-white flex items-center gap-1.5 px-4 py-1.5 rounded text-sm font-semibold hover:bg-[#2d4373] transition shadow-sm mb-[1px]">
      ...
      <div className="bg-white border border-gray-200 rounded shadow-sm">
        ...
        <div className="flex border-b border-gray-200 bg-white px-2">
          <button 
            ...
            className={`flex items-center gap-1.5 px-4 py-3 text-sm font-semibold border-b-2 transition-colors ${activeTab === 'list' ? 'border-[#3b5998] text-[#3b5998]' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
          >
            <Icons.List className="w-4 h-4" /> List View
          </button>
          <button 
            onClick={() => setActiveTab('details')}
            className={`flex items-center gap-1.5 px-4 py-3 text-sm font-semibold border-b-2 transition-colors ${activeTab === 'details' ? 'border-[#3b5998] text-[#3b5998]' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
          >
                  ...
                  <tbody>
                    {students.map((student, i) => (
                      <tr key={i} className="border-b border-gray-100 hover:bg-gray-50 bg-white">
                        ...
                        <td className="px-4 py-3 text-blue-600">{student.name}</td>
                        ...
                        <td className="px-4 py-3 text-right">
                           <div className="flex justify-end gap-1">
                              <button className="bg-[#3b5998] p-1.5 rounded hover:bg-[#2d4373] text-white" title="Menu">
                              ...
                              <button className="bg-[#3b5998] p-1.5 rounded hover:bg-[#2d4373] text-white" title="Fees">
                                 <Icons.IndianRupee className="w-3 h-3 stroke-[3]" />
                              </button>
                              <button className="bg-[#3b5998] p-1.5 rounded hover:bg-[#2d4373] text-white" title="Print">
