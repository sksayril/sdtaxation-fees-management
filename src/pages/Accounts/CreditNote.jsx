          ...
          <div className="flex justify-between items-start">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                <div className="bg-[#FFA1AD] text-gray-800 px-6 py-1.5 rounded-sm text-[13px] font-bold w-32 text-center italic border border-gray-200">
                  Voucher No.
                </div>
            ...
            {/* Date Row */}
            <div className="flex items-center gap-2">
              <div className="bg-[#FFA1AD] text-gray-800 px-8 py-1.5 rounded-sm text-[13px] font-bold italic border border-gray-200">
                Date
              </div>
