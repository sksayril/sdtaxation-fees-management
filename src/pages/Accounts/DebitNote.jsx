...
export function DebitNote() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f3f4f6] font-sans">
      {/* Colored Header */}
      <div className="bg-[#ED6AFF] text-white px-4 py-2 flex justify-between items-center text-[14px] font-bold border-b border-gray-300">
        <span>ACCOUNTING VOUCHER CREATION (DEBIT NOTE)</span>
      ...
      <div className="p-6 flex flex-col gap-4">
        ...
        <div className="bg-white p-6 rounded-sm shadow-sm flex flex-col gap-4 border border-gray-200">
          <div className="flex justify-between items-start">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                <div className="bg-[#ED6AFF] text-white px-6 py-1.5 rounded-sm text-[13px] font-bold w-32 text-center italic">
                  Voucher No.
                </div>
            ...
            {/* Date Row */}
            <div className="flex items-center gap-2">
              <div className="bg-[#ED6AFF] text-white px-8 py-1.5 rounded-sm text-[13px] font-bold italic">
                Date
              </div>
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            <span className="text-[14px] font-bold text-gray-800">: ₹ 25,000.00 Cr</span>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <button className="bg-[#ED6AFF] text-white px-8 py-2 rounded-sm font-bold text-sm hover:bg-[#d64bff] transition shadow-md">
            Save Debit Note
          </button>
        </div>
      </div>
