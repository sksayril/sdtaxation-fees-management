...
export function Sales() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f3f4f6] font-sans">
      {/* Colored Header */}
      <div className="bg-[#FFC9C9] text-gray-800 px-4 py-2 flex justify-between items-center text-[14px] font-bold border-b border-gray-300">
      ...
      <div className="p-6 flex flex-col gap-4">
          ...
          <div className="flex justify-between items-start">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                <div className="bg-[#FFC9C9] text-gray-800 px-6 py-1.5 rounded-sm text-[13px] font-bold w-32 text-center italic border border-gray-300">
                  Voucher No.
                </div>
            ...
            {/* Date Row */}
            <div className="flex items-center gap-2">
              <div className="bg-[#FFC9C9] text-gray-800 px-8 py-1.5 rounded-sm text-[13px] font-bold italic border border-gray-300">
                Date
              </div>
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <button className="bg-[#FFC9C9] text-gray-800 px-8 py-2 rounded-sm font-bold text-sm hover:bg-[#ffbaba] transition shadow-md border border-gray-300">
            Save Sales Voucher
          </button>
        </div>
      </div>
